...
class DepthwiseSeparableASPPRAResHead(ASPPHead):
    ...
    def __init__(self, c1_in_channels, c1_channels, num_tokens, num_heads, **kwargs):
        super(DepthwiseSeparableASPPRAResHead, self).__init__(**kwargs)
        self.num_tokens = num_tokens
        ...
        self.conv_seg = nn.Conv2d(self.channels*(num_tokens+1), self.out_channels, kernel_size=1)
    ...
    def forward(self, inputs):
        ...
        output1 = (output.unsqueeze(1) * attn).flatten(1, 2)
