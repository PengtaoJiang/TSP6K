...
def getPrediction( args, groundTruthFile, result_dir):
...
#         printError("Found no prediction for ground truth {}".format(groundTruthFile))
    ...
    predictionFile = os.path.join(result_dir, groundTruthFile[-21:-8]+ '.png')
...
args.avgClassSize       = {
    "bicycle"    :  3517.7833902837615 ,
    "motorcycle" :  5823.252793395488 ,
    "rider"      :  3071.2105841371917 ,
    "bus"        : 97415.74013797984 ,
    "car"        : 27091.666429908957 ,
    "person"     :  2685.1469159025 ,
    "truck"      : 63410.60930773705 ,
}
...
def evaluatePair(predictionImgFileName, groundTruthImgFileName, confMatrix, instanceStats, perImageStats, args):
    ...
    if args.evalInstLevelScore:
        groundTruthInstanceImgFileName = groundTruthImgFileName.replace("eval", "ins")
        try:
