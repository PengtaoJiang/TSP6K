...
class DepthwiseSeparableASPPCA2Head(ASPPHead):
    ...
    def __init__(self, c1_in_channels, c1_channels, num_heads, **kwargs):
        super(DepthwiseSeparableASPPCA2Head, self).__init__(**kwargs)
    ...
    def forward(self, inputs):
        ...
        attn = self.ca_block(output1).mean(1)[:, :, 21:].view(B, 21, H, W) # B, N, C
