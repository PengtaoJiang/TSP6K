...
class ClassAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        q = self.q(x[:, :21, :]).reshape(B, 21, self.num_heads, self.head_dim).permute(0, 2, 1, 3)
...
class DepthwiseSeparableASPPRAClassHead(ASPPHead):
    ...
    def __init__(self, c1_in_channels, c1_channels, num_heads, **kwargs):
        super(DepthwiseSeparableASPPRAClassHead, self).__init__(**kwargs)
